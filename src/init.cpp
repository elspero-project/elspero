...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/elspero-project/elspero>";
    const std::string URL_WEBSITE = "<https://www.elspero.org>";
